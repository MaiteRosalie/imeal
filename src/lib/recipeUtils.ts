...
export function aggregateShoppingFromRecipes(
  ...
  const aggregated: Record<
    string,
    { quantity: number; unit: string; category: string; cost: number }
  > = {};
...
function getIngredientCategory(ingredientName: string): string {
  ...
  if (
    ...
    name.includes("rice noodle") ||
    name.includes("tortilla") ||
    name.includes("bread") ||
    name.includes("pita") ||
    name.includes("burger bun") ||
    name.includes("pizza dough") ||
    name.includes("pie crust") ||
    name.includes("breadcrumb") ||
    name.includes("taco seasoning") ||
    name.includes("chili powder") ||
    name.includes("cumin") ||
